...
export const OFFICE_PRESETS: Record<string, OfficePreset> = {
  ...
  office_order: { h1:'भारत सरकार', h2:'कार्मिक एवं प्रशिक्षण विभाग', e1:'Government of India', e2:'Department of Personnel & Training', dept:'Administration Division', divn:'(Establishment Desk)', ofc:'North Block', city:'New Delhi', pin:'110 001', ph:'011-23092000', em:'dopt-admin@gov.in', wb:'www.dopt.gov.in', ll:null, lr:'ashoka', t:'A' },
  rti:      { h1:'सूचना का अधिकार', h2:'RTI प्रकोष्ठ', e1:'Right to Information Cell', e2:'Statutory Filing Department', dept:'Public Information Office', divn:'(RTI Act, 2005)', ofc:'Central Secretariat', city:'New Delhi', pin:'110 001', ph:'', em:'rti-cell@gov.in', wb:'www.rtionline.gov.in', ll:null, lr:'ashoka', t:'A' },
  leave:    { h1:'अवकाश आवेदन', h2:'प्रशासन शाखा', e1:'Application for Leave', e2:'Department of Posts', dept:'Divisional Office', divn:'(Establishment Branch)', ofc:'O/o the Supdt. of Post Offices', city:'Nagpur', pin:'440 001', ph:'', em:'', wb:'', ll:'ip', lr:'ashoka', t:'A' },
};
...
export const AI_LETTER_TYPES: Array<{ value: string; label: string }> = [
  ...
  { value: 'om',                 label: 'Office Memorandum (OM - 3rd Person)' },
  { value: 'do',                 label: 'Demi-Official (D.O.) Letter' },
  { value: 'circular',           label: 'Circular / Standing Directive' },
  { value: 'reminder',           label: 'Reminder Letter (Urgent / Pending)' },
  { value: 'scn',                label: 'Show Cause Notice (Statutory / Disciplinary)' },
  { value: 'noc',                label: 'No Objection Certificate (NOC)' },
  { value: 'appreciation',       label: 'Letter of Appreciation (Minister / Gov)' },
  { value: 'notification',       label: 'Public Notification (Gazette Format)' },
  { value: 'advisory',           label: 'Advisory / Policy Guidelines' },
  ...
  { value: 'personal',           label: 'General Personal / Unofficial Letter' },
  { value: 'custom',             label: 'Custom Official Letter' },
];
